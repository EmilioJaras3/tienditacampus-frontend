...
\begin{document}
    ...
    \begin{tcolorbox}[colback=yellow!10!white,colframe=yellow!40!black,title=Estado del documento]
        Este archivo es una especificaci\'on hist\'orica/acad\'emica. No debe usarse como fuente operativa principal del sistema actual. Para el estado vigente del checkout, consultar \texttt{docs/CONTEXTO\_PROYECTO.md}, \texttt{docs/guides/} y \texttt{docs/api/endpoints.md}.
    \end{tcolorbox}
