    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <button className="flex items-center gap-3 px-8 h-16 bg-destructive text-destructive-foreground border-2 border-foreground/10 font-bold text-xs tracking-widest uppercase hover:opacity-90 transition-all rounded-xl shadow-neo rotate-1 hover:rotate-0 active:scale-95">
                    <Calculator size={18} /> CERRAR DÍA
                </button>
            </DialogTrigger>
