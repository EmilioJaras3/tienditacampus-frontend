-- ============================================================
-- SCRIPT DE POBLAMIENTO DE VALIDACIÓN FINAL (TRUE UUIDs V2)
-- ============================================================
...
-- 3. Usuarios (Sellers y Buyers) con UUIDs Reales
...
-- 4. Products (usando seller_id UUID)
...
BEGIN
    FOR i IN 1..100 LOOP
        -- Seleccionar un comprador al azar
