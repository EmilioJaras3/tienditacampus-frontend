-- ============================================================
-- SCRIPT DE POBLAMIENTO DE VALIDACIÓN FINAL V3 (TRUNCATE CASCADE)
-- ============================================================

BEGIN;

-- 1. Limpieza absoluta con CASCADE
TRUNCATE order_items, orders, products, inventory_records RESTART IDENTITY CASCADE;

-- 2. Limpieza de usuarios (excepto admin)
DELETE FROM users WHERE email NOT LIKE 'jaras%';

-- 3. Usuarios (Sellers y Buyers)
